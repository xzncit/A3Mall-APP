			...
			<view v-if="!isLoading && isError == false">
				...
				<view class="swiper-box">
					<swiper
						...
						:autoplay="swiper.duration" 
						interval="5000"
						:duration="swiper.duration"
						indicator-active-color="#b71c1c"
					 >
						<swiper-item 
							class="have-none" 
				...
				<view class="notice-box" @click="$utils.navigateTo('news/view',{ id: notice.id })" v-if="notice.title">
					<view class="notice-icon iconfont" style="color: #b91922;">&#xea80;</view>
					<view class="notice-text" style="color: #b91922;">{{ notice.title }}</view>
				</view>
...
<script>
	...
	export default {
		...
		components:{
			MescrollBody,MescrollUni,loading
		},
		data() {
			return {
				swiper: {
...
<style lang="scss" scoped>
    ...
    .host-box { width: 100%; height: 520rpx; background-color: #b91922; }
