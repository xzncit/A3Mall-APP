		...
		<mescroll-body ref="mescrollRef" :up="upOption" @init="mescrollInit" @down="downCallback">
			...
			<view v-if="!isLoading">
				...
				<view class="goods-price">
					<view class="price">
						<view><text class="icon iconfont">&#xe65e;</text><text>{{ products.sell_price }}</text><text>积分</text></view>
				...
				<view class="goods-comments clear">
					<view class="title">
						<text>商品评价</text>
						<text v-if="comments.length > 0" @click="$utils.navigateTo('comments/view',{ id: goods_id,type: 'point' })">更多 &gt;</text>
					</view>
    ...
    methods: {
        ...
        loadGoodsData(){
            this.$http.getPointDetail({
				...
				this.url = this.$config.uni_app_web_url + "point/view/" + this.goods_id;
		...
		onGoBuy(){
			this.$utils.navigateTo("goods/view",{ id: this.products.goods_id });
		},
        onBuyClicked(){
            ...
            this.$store.dispatch("usersStatus").then(()=>{
                ...
                this.$storage.set("VUE_REFERER","/point/view/id/"+this.goods_id);
    ...
    .price {
        ...
        view {
            ...
            &:first-child {
                ...
                text:nth-child(1){
                    font-size: 42rpx;
                    color: #fbcb40; padding-right: 6rpx;
                }
                text:nth-child(2){
                    font-size: 42rpx;
                }
...
.count-down-box {
    ...
    /deep/.simple{
        ...
        .tips-simple{ color: #ffc241; padding-right: 32rpx; height: 140rpx; line-height: 140rpx }
    }
}
.goods-info{
